...
DROP   PROGRAM NN_ALF_ICU_MEDICAL_HANDOVER:dba GO
CREATE PROGRAM NN_ALF_ICU_MEDICAL_HANDOVER:dba
...
and se.sch_action_cd = 3626			; 14232 check in
and se.active_ind = 1
...
detail
	...
	;if((apptinfo->appt_data[d1.seq].appt_status = "Checked In") and (trim(o.label_text) = "E Receipt Fee"))
   	if(trim(o.label_text) = "E Receipt Fee")
